...
save('ReCUdata.mat','ml','pl','mr','pr','C','a','o','lamdal','lamdar','Confidencel','Confidencer','al_prob','Beta')
end
%sim_data=[{ppl},{T},{lamdal},{lamdar},{Pl},{Pr},{Confidencel},{Confidencer},{Infogainl},{Infogainr},{Dl},{Dr},{Gl},{Gr}]
