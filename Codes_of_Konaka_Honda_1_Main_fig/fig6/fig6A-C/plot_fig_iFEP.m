...
colormap('redblue')
hold on
plot(dR(aa==1 & C_under==1 & C_under2==0),dInfo(aa==1 & C_under==1 & C_under2==0),'. b','Markersize',10)
hold on
plot(dR(aa==0 & C_under==1 & C_under2==0),dInfo(aa==0 & C_under==1 & C_under2==0),'. r','Markersize',10)
...
b_dR=dR(C_under==1 & C_under2==0);
b_dInfo=dInfo(C_under==1 & C_under2==0);
b_a=a(C_under==1 & C_under2==0)
