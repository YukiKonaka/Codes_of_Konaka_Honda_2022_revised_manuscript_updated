...
subplot(3,3,9);
shadedErrorBar(2:T,ps_C(2:end)/mean(pf_beta),SD_C(2:end)/mean(pf_beta(1000:end))); 
hold on
plot(2:T,ps_C(2:end)/mean(pf_beta),'- r')
hold on;
...
int_curi=ps_C/mean(pf_beta);
SD_curi=SD_C/mean(pf_beta(1000:end));
