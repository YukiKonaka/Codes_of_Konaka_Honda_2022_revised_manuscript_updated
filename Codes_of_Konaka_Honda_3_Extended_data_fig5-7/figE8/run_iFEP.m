...
% run particle filter
myPF = particleFilter(@state_transition_iFEP,@likelihood_iFEP);
...
% run smoother
smoother=run_smoother_iFEP(filter,a,o,C_noise);
...
est_data_doya=[{ppl},{a},{o},{ps_rpl},{SD_rml},{ps_rpr},{SD_rmr},{ps_precl},{SD_rpl},{ps_precr},{SD_rpr},{ps_C},{pf_beta},{SD_C},{T},{ps_ml},{ps_mr},{ps_pl},{ps_pr},{pf_vw}]
